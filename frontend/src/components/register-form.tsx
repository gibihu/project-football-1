...
const schema = z.object({
    ...
    confirm_password: z.string().min(1, "กรุณากรอกรหัสผ่าน").min(6, "รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร"),
        ...
        const fetchData = async ()=>{
            ...
            try {
                ...
                if(res.status == 200){
                    ...
                    toast.success(result.message, {description: 'ระบบบันทึกข้อมูลการสมครแล้ว รอสักครู่ระบบจะนำทางไปหน้าต่อไป'});
                    navigate("/login");
                }else{
                    const errors = await res.json();
                    console.log(errors);
                    setError('confirm_password', {message: errors.errors.password});
                    ...
                    <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                <h1 className="text-2xl font-bold">ยินดีต้อนรับ {API_NAME}</h1>
                                <p className="text-muted-foreground text-balance">
                                    เริ่มสมัครสมาชิกกับเรา!
                                </p>
                            </div>
                            ...
                            <div className="grid gap-3">
                                ...
                                <Input id="password" type="password"
                                    placeholder="เช่น johnny, milk@cow"{...register("password")} />
                                {errors.password && (
                            ...
                            <div className="grid gap-3">
                                ...
                                <Input id="confirm_password" type="password" placeholder="รหัสผ่านต้องเหมือนกัน" {...register("confirm_password")} />
