...
CREATE TABLE IF NOT EXISTS users (
    -- UUID v4 เก็บเป็น string 36 ตัว
...
CREATE TABLE IF NOT EXISTS packages (
    ...
    price DECIMAL(21, 2) UNSIGNED NOT NULL,
    price_per_points DECIMAL(12, 2) UNSIGNED NOT NULL,
    published BOOLEAN NOT NULL DEFAULT TRUE,
    is_promo BOOLEAN NOT NULL DEFAULT FALSE,
    promo_title VARCHAR(50) NULL,
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    -- อ้างอิงไปยัง packages.uuid
    package_id CHAR(36) NOT NULL,
    -- อ้างอิงผู้ใช้ใส่เอง (เช่นหมายเหตุในสลิปโอนเงิน)
    user_reference VARCHAR(10) NULL,
    -- รหัสอ้างอิง เช่น เลขที่ธุรกรรมจาก payment gateway
    ...
    -- ยอดเงินที่ต้องจ่าย
    points DECIMAL(12) NOT NULL,
    -- รองรับหลายสกุลเงินในอนาคต
    ...
    -- หลักฐานการโอน (ถ้าเป็น manual)
    slip_url VARCHAR(255) NULL,
    -- เวลาที่ชำระเงิน (จริง)
    paid_at TIMESTAMP NULL,
    -- เวลาที่แอดมินกดอนุมัติ
    ...
    -- transaction id ของ gateway
    gateway_txn_id VARCHAR(100) NULL,
    -- เก็บ response ดิบจาก gateway
